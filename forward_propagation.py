...
def apply_batchnorm(A, eps=0.000001):
    """
...
A    :param parameters: the initialized W and b parameters of each layer
...
def compute_cost(AL, Y, eps=0.00000001):
    """
    ...
    return np.mean(-Y * np.log(AL + eps))
